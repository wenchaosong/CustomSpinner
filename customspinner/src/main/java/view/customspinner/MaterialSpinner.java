...
//        setMinimumHeight(top + bottom + minContentHeight);
    ...
    */
    ...
    public void setData(Context context, int spinner_item, String[] items) {
//        ArrayAdapter<String> adapter = new ArrayAdapter<>(context, android.R.layout.simple_spinner_item, items);
        ArrayAdapter<String> adapter = new ArrayAdapter<>(context, spinner_item, items);
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        private HintAdapter(SpinnerAdapter spinnerAdapter, Context context) {
        ...
        private View getHintView(ViewGroup parent, boolean isDropDownView) {
            ...
            final int resid = isDropDownView ? res_id : R.layout.child;
            View view = inflater.inflate(resid, parent, false);
            TextView text = (TextView) view.findViewById(R.id.text);
            text.setText(hint);
            text.setTextColor(MaterialSpinner.this.isEnabled() ? hintColor : disabledColor);
            text.setTag(HINT_TYPE);
            return view;
        }
